...
function ImageWrapperControl_ShowRollOverCoverImage(rolloverurl, rolloverDisplayMilliseconds) {
    Tip('<div id=ej-box-image-hover class="ej-box-bordered-hover"><img src=' + rolloverurl +
    '/></div>', BORDERWIDTH, 0, SHADOW, false, BGCOLOR, '', WIDTH, 0, DELAY, rolloverDisplayMilliseconds);
...
function ImageWrapperControl_ShowReferenceHover(referenceText, rolloverDisplayMilliseconds) {
    Tip('<div id=box-modal-drop-shadow-hover><div id=box-text-hover>' + referenceText + '</div></div>', BORDERWIDTH, 0, SHADOW, false, BGCOLOR, '', WIDTH, 0, FONTCOLOR, '#000000', DELAY, rolloverDisplayMilliseconds);
}
